...
def subMenu_ps():
    print()
    print()
    print('''Welcome to the English-Serbian Dictionary:
            1. Search word
            2. Add word
            3. Change word
    ...
    if choice == '1':
        ...
        add_english = input('Enter English word: ')
        add_serbian = input('Enter Serbian word: ')
        adding_p(add_english, add_serbian)
        subMenu_ps()
    elif choice == '3':
...
# Search a English word in the Dictionary


def searching_p(search_p):
    if search_p in mydict_ps:
        print('This English word in Serbian means: ', mydict_ps[search_p])
    else:
        print('This word is not in a dictionary')
    return

# Adding a new English word to the Dictionary


def adding_p(add_english, add_serbian):
    mydict_ps[add_english] = add_serbian
    print('Done!')
...
# Correcting a English word in the Dictionary
...
def subMenu_sp():
    ...
    if choice == '1':
        ...
        add_serbian = input('Enter Serbian word: ')
        add_english = input('Enter English word: ')
        adding_p(add_serbian, add_english)
        subMenu_sp()
    elif choice == '3':
...
def searching_s(search_s):
    if search_s in mydict_sp:
        print('This English word in Serbian means: ', mydict_sp[search_s])
    else:
        print('This word is not in a dictionary')
    return
...
def adding_s(add_serbian, add_english):
    mydict_sp[add_serbian] = add_english
    print('Done!')
